...
## A unified interface for motion tracks {.smaller}
...
![](img/movement_poses_dataset_card.png){height=350}


::: aside
See also:

- [movement.neuroinformatics.dev](https://movement.neuroinformatics.dev/) > User Guide > Input/Output
- [movement.neuroinformatics.dev](https://movement.neuroinformatics.dev/) > User Guide > The movement datasets
:::
